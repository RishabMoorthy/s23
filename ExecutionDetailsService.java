...
public class ExecutionDetailsService {
     ...
     *
     * <p>A .vs with no execution mode is skipped entirely - see the guard at the top.
     *
     * @throws ExecutionModeSyncException when a service that does use the feature cannot be
     *                                    resolved: stubserver.ip is not configured, or the
     *                                    service is not in READYAPI_VS_CATALOG. Both are
    ...
    public void syncExecutionMode(ServiceConfig config, boolean quiet) {
        ...
        // An empty <ExecutionModeValue/> means the service does not use this feature at all.
        // Nothing is read and nothing is written: no stubserver.ip check, no catalog lookup,
